...
public class Barbietrivia {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null,"WELCOME TO ZOMBIE SURVIVAL TRIVIA , Click 'OK' to continue","ZOMBIE TRIVIA",JOptionPane.DEFAULT_OPTION,icon );
        ...
        if ("2".equals(userAnswer))
        {
            JOptionPane.showMessageDialog(null,"\tCORRECT ANSWER, BOW ALLOW TO HUNT SILENTLY FROM A SAFE DISTANCE");
            points ++;
